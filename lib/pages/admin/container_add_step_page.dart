...
class CTrackerAddStepPage extends StatefulWidget {
  final TrackingContainer trackingContainer;
  CTrackerAddStepPage({Key key, this.trackingContainer}) : super(key: key);

  @override
  _CTrackerAddStepPageState createState() => _CTrackerAddStepPageState();
}

class _CTrackerAddStepPageState extends State<CTrackerAddStepPage> {
